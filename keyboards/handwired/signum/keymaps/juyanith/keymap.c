...
#define _S_DEL MT(MOD_LSFT, KC_DEL)
#define _S_BKSP MT(MOD_LSFT, KC_BSPC)
#define _L_SPC LT(_RAISE, KC_SPC)
#define _R_ENT LT(_LOWER, KC_ENT)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KEYMAP(
		...
		TO_LOWR, KC_ESC,  KC_LGUI, KC_LALT, _C_DEL,  _S_BKSP,      _L_SPC,  _R_ENT,  KC_BSPC, KC_DEL,  KC_APP,  TO_RAIS),
	...
	KEYMAP(
		...
		_______, _______, _______, _______, _______, _______,      _______, _______, _______, _______, _______, TO__BASE),
	...
	KEYMAP(
		...
		TO__BASE, _______, _______, _______, _______, _S_DEL,      _______, _______, _______, _______, _______, _______),
