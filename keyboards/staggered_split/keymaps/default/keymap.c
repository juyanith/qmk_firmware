...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_COLEMAK] = LAYOUT_ortho_5x12(
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                                              KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RCTL,
    ...
    KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,                                             KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,
		...
		_______, KC_TILD, KC_GRV,  KC_UNDS, KC_LCBR, KC_LBRC,                                           KC_RBRC, KC_RCBR, KC_MINS, KC_PLUS, KC_BSLS, _______,
