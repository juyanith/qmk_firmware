 ...
 * |--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+-----------------+--------+--------|
 * | CTRL   | OS     | ALT    | CTRL   | SHIFT  | BACKSP | DELETE | CAPS   | SHIFT  | ENTER  | SPACE  | FN     | MENU   | OS     | CTRL   |
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */

	[_COLEMAK] = LAYOUT(
		KC_GESC, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_LBRC, KC_APP,  KC_RBRC, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, 
		...
		KC_LCTL, KC_LGUI, KC_LALT, KC_LCTL, _SH_SP_, _L_SYM1, KC_DEL,  KC_CAPS, KC_RSFT, _L_SYM2, KC_SPC,  _L_NAV,  KC_APP,  KC_RGUI,  KC_RCTL),
  ...
  [_ADJUST] = LAYOUT(
		...
		XXXXXXX, _T_QWRT, XXXXXXX, XXXXXXX, XXXXXXX, _D_STA1, XXXXXXX, XXXXXXX, XXXXXXX, _D_STA2, RGB_HUI, RGB_SAI, RGB_VAI, RGB_MOD, XXXXXXX, 
		KC_INS,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _D_PLA1, XXXXXXX, XXXXXXX, XXXXXXX, _D_PLA2, RGB_TOG, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, 
		XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _D_STOP, XXXXXXX, XXXXXXX, XXXXXXX, _D_STOP, RGB_HUD, RGB_SAD, RGB_VAD, RGB_RMOD,XXXXXXX,
