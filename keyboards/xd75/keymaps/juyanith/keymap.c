 ...
 * |--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+-----------------+--------+--------|
 * | ???    | OS     | ALT    | CTRL   | SHIFT  | BACKSP | DELETE |        |        | ENTER  | SPACE  | FN     | MENU   | INS    | ???    |
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */
	...
	[_COLEMAK] = LAYOUT(
		...
		XXXXXXX, KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, _L_SYM1, KC_DEL,  XXXXXXX, XXXXXXX, _L_SYM2, KC_SPC,  _L_NAV,  KC_APP,  KC_INS, XXXXXXX),
